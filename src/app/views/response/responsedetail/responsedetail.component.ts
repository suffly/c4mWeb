...
export class ResponsedetailComponent implements OnInit, OnDestroy {
  ...
  loadData(){
      ...
      console.log("LoadResponseDetail, MeetingID : "+this.Meetingrow+" CounselorID : "+this.Counselorrow+" ConsulationID : "+this.Consulationrow+" CSLMID : "+this.Consulationministryrow+" Response : "+this.Responserow);
  ...
  loadResponse() {
    ...
    Response_input.consulationministry_id = this.Consulationministryrow;
    const subscribe = (this.ResponseService.GetResponse_byConsulationministry(Response_input)).subscribe(data => {
