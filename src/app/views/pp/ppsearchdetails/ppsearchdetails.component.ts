...
@Component({
  selector: 'app-ppsearchdetails',
  templateUrl: './ppsearchdetails.component.html',
  styleUrls: ['./ppsearchdetails.component.css']
})
export class PpsearchdetailsComponent implements OnInit, OnDestroy  {
  ...
  loadConsulation() {
    ...
    Ppsearch_input.consulationdetail_id = this.subid;
  ...
  loadMinistry() {
    ...
    Consulationministryview_input.consulationdetail_id = this.subid;
  ...
  loadProvince() {
    ...
    Consulationprovinceview_input.consulationdetail_id = this.subid;
  ...
  loadAttach() {
    ...
    Attach_input.consulationdetail_id = this.subid;
  ...
  viewResponse(i: number, data: Consulationministryview) {
    ...
    this.index = i;
    this.Ppsearchdetailrow = data.consulationministry_id;
    this.Ppsearchrow = data.consulationdetail_id;
    localStorage.setItem('ppconsultationministry' , JSON.stringify(this.Ppsearchdetailrow));
