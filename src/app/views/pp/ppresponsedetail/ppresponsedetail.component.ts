...
@Component({
  selector: 'app-ppresponsedetail',
  templateUrl: './ppresponsedetail.component.html',
  styleUrls: ['./ppresponsedetail.component.css']
})
export class PpresponsedetailComponent implements OnInit, OnDestroy {
  ...
  loadData(){
      this.Ppresponserow = JSON.parse(localStorage.getItem('ppresponse')||'{}');
      this.loadResponse();
      this.loadAttachres();
  }
